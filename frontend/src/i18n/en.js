...
const en = {
  ...
  settings: {
    ...
    digitalSets: 'Digital-only sets',
    digitalSetsDesc: 'Show and sync Pokemon TCG Pocket sets. Turning this off removes imported digital-only sets and cards from the local catalogue.',
    ...
    rescueDonationTotal: 'Donated to animal rescue so far',
    rescueDonationBatchHint: 'Supporter tips are sent to rescues later in batches',
  ...
  scanner: {
    ...
    aiHint: 'Recognition via Gemini AI - automatically detects supported TCGdex languages',
