...
const de = {
  ...
  settings: {
    ...
    digitalSets: 'Nur digitale Sets',
    digitalSetsDesc: 'Pokémon TCG Pocket Sets anzeigen und synchronisieren. Wenn deaktiviert, werden importierte digitale Sets und Karten aus dem lokalen Katalog entfernt.',
  ...
  scanner: {
    ...
    aiHint: 'Erkennung via Gemini AI - erkennt automatisch unterstützte TCGdex-Sprachen',
