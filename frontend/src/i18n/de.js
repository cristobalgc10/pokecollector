...
const de = {
  ...
  collection: {
    ...
    csvImportOptionalSummary: 'Optionale Felder dürfen leer bleiben. Standardwerte: quantity 1, condition NM, lang en. variant nur für Holo, Reverse Holo oder First Edition nutzen.',
    csvImportDefaultsTitle: 'Standardwerte bei leeren Feldern',
    csvImportBlankOptionalHint: 'variant und purchase_price können leer bleiben, außer du möchtest diese Details importieren.',
    ...
    csvImportColumnLang: 'optional; Standard en; en/de',
    csvImportColumnPurchasePrice: 'optional; Kaufpreis pro Karte',
    csvImportAllowedValues: 'Erlaubte Werte: condition Mint/NM/LP/MP/HP · variant leer/Normal/Holo/Reverse Holo/First Edition · lang en/de.',
  ...
  products: {
    ...
    subtitle: 'Sealed-Product-Käufe und G&V verfolgen',
  ...
  settings: {
    ...
    about: 'Über',
    aboutDesc1: 'Pokémon TCG Sammlungs-Manager v1.16',
  ...
  scanner: {
    ...
    aiHint: 'Erkennung via Gemini AI — erkennt automatisch Deutsch und Englisch',
    recognizing: 'Karte wird erkannt…',
    analyzing: 'Gemini analysiert das Bild',
    detected: 'Erkannt',
